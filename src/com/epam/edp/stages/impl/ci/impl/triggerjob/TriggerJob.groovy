...
class TriggerJob {
    ...
    void run(context) {
        script.print("[DEBUG] job: ${context.job.triggerJobName}, wait: ${context.job.triggerJobWait}, propagate: ${context.job.triggerJobPropogate}, parameters: ${context.job.triggerJobParameters}")
