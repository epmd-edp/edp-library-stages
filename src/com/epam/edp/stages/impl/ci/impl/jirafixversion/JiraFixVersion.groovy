...
class JiraFixVersion {
    ...
    def commitHashForBuild(build) {
        def hoho = build.getAction(hudson.plugins.git.util.BuildData.class).lastBuiltRevision.sha1String
        script.println("[JENKINS][DEBUG] hohohohohohohohohohohohohoho ${hoho}")
