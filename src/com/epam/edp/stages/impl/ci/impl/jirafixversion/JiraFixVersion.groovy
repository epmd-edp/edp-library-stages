...
class JiraFixVersion {
    ...
    void run(context) {
        script.dir("${context.workDir}") {
            ...
            def res = new com.github.jenkins.lastchanges.pipeline.LastChangesPipelineGlobal(script)
            def publisher = res.getLastChangesPublisher(lastSuccessfulBuild, "SIDE", "LINE", true, true, "", "", "", "", "")
