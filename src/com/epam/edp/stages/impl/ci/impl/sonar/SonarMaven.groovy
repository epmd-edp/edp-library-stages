...
class SonarMaven {
    ...
    def sendReport(context) {
            script.sonarToGerrit inspectionConfig: [baseConfig: [projectPath: "", sonarReportPath: "${context.workDir}/target/sonar/sonar-report.json"], serverURL: "https://sonar-oc-green-sk-dev-dev.delivery.aws.main.edp.projects.epam.com"],
