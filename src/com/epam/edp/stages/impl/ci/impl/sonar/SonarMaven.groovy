...
class SonarMaven {
    def getSonarReportJson(context.codebase.name, context.sonar.route, codereviewAnalysisRunDir) {
    ...
    def sendReport(context.sonar.route, codereviewAnalysisRunDir) {
    ...
    void run(context) {
        ...
        if (context.job.type == "codereview") {
            ...
            getSonarReportJson(context.codebase.name, context.sonar.route, codereviewAnalysisRunDir)
        } else {
