...
class SonarMaven {
    ...
    def sendSonarScan(sonarProjectKey, sonarProjectName, codereviewAnalysisRunDir) {
        script.dir("${codereviewAnalysisRunDir}") {
    ...
    void run(context) {
        ...
        script.sendSonarScan(context.codebase.name, context.codebase.name, codereviewAnalysisRunDir)
        script.timeout(time: 10, unit: 'MINUTES') {
