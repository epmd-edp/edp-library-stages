...
class SonarMaven {
    ...
    def getSonarReportJson(context, sonarUrl = "https://sonar-oc-green-sk-dev-dev.delivery.aws.main.edp.projects.epam.com/") {
        String sonarAnalysisStatus
        def sonarJsonReportLink = "${sonarUrl}/api/issues/search?componentKeys=${context.codebase.name}&branch=${context.codebase.branchVersion}&resolved=false&facets=severities"
