...
class SonarDotnetApplicationLibrary {
    ...
    void run(context) {
        ...
        def scannerHome = context.codebase.config.framework == "netcore" ? "dotnet script.tool 'SonarScannerMSBuild'/SonarScanner.MSBuild.dll" : "/home/jenkins/.dotnet/tools/dotnet-sonarscanner"
