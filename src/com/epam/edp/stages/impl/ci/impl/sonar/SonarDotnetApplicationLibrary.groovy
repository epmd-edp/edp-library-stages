...
class SonarDotnetApplicationLibrary {
    ...
    def sendReport(sonarURL, codereviewAnalysisRunDir) {
        script.dir("${codereviewAnalysisRunDir}") {
            script.sonarToGerrit inspectionConfig: [baseConfig: [projectPath: "", sonarReportPath: "${codereviewAnalysisRunDir}/.sonarqube/out/.so/sonar-report.json"], serverURL: "${sonarURL}"],
