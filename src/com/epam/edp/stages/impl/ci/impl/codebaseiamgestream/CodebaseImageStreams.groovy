...
class CodebaseImageStreams {
    ...
    def UpdateOrCreateCodebaseImageStream(cbisName, repositoryName, imageTag) {
        ...
        if (!this.context.platform.checkObjectExists(crApi, cbisName)) {
            ...
            def template = new JsonSlurperClassic().parseText(getCbisTemplate())
        ...
        def cbisCr = new JsonSlurperClassic().parseText(this.context.platform.getJsonValue(crApi, cbisName))
