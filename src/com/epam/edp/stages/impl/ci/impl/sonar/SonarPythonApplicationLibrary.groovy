    ...
    void run(context) {
        script.dir("${context.workDir}") {
            ...
            script.withSonarQubeEnv('Sonar') {
                ...
                script.sh "pip install pytest-cov"
                ...
                script.sh "${scannerHome}/bin/sonar-scanner " +
                          ...
                          "-Dsonar.coverage.exclusions=**__init__**,tests/**,allure-report/**,run.py,build/**,setup.py,server.py " +
                          "-Dsonar.exclusions=*.xml,allure-report/** " +
