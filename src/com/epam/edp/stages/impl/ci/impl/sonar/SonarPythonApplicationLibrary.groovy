...
class SonarPythonApplicationLibrary {
    ...
    def sendStatusToGerrit(workDir, sonarURL) {
        script.dir("${workDir}") {
            script.sonarToGerrit inspectionConfig: [autoMatch: true, baseConfig: [autoMatch: true, projectPath: "", sonarReportPath: "${workDir}/.scannerwork/sonar-report.json"], serverURL: "${sonarURL}"],
                    notificationConfig: [commentedIssuesNotificationRecipient: 'ALL', negativeScoreNotificationRecipient: 'ALL', noIssuesNotificationRecipient: 'ALL'],
