    ...
    void run(context) {
        ...
        script.dir("${context.workDir}") {
            try {
                ...
                script.publishHTML([allowMissing: false, alwaysLinkToLastBuild: false, keepAll: true, reportDir: "${context.workDir}", reportFiles: "microscanner-report.html", reportName: 'Aqua Microscanner Report', reportTitles: ''])
