        ...
        script.dir("${context.workDir}") {
            script.withCredentials([script.usernamePassword(credentialsId: "${context.nexus.credentialsId}",
                ...
                if (context.codebase.config.versioningType == "edp") {
                    ...
                    script.println(context.codebase.config.codebase_branch.build_number.get(branchIndex).toInteger())
                    script.println(context.codebase.config.codebase_branch.version.get(branchIndex).toInteger())
