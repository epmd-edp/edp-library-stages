...
class GetVersionMavenApplicationLibrary {
    ...
    void run(context) {
        script.dir("${context.workDir}") {
            ...
            context.job.setDisplayName("11111111111111111111111")
            script.println("-----------------------------------------")
            script.println("${script.currentBuild.number}")
            script.println("${context.git.branch}")
            script.println("${context.codebase.version}")
